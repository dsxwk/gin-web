...
// 引入组件
const LayoutParentView = defineAsyncComponent(() => import('/@/layouts/routerView/parent.vue'));
const LayoutFooter = defineAsyncComponent(() => import('/@/layouts/footer/index.vue'));
