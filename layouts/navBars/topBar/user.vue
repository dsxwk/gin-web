...
import avatar from '/@/static/assets/tx.png';

// 引入组件
const UserNews = defineAsyncComponent(() => import('/@/layouts/navBars/topBar/userNews.vue'));
const Search = defineAsyncComponent(() => import('/@/layouts/navBars/topBar/search.vue'));
