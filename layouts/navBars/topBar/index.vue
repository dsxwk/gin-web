...
// 引入组件
const Breadcrumb = defineAsyncComponent(() => import('/@/layouts/navBars/topBar/breadcrumb.vue'));
const User = defineAsyncComponent(() => import('/@/layouts/navBars/topBar/user.vue'));
const Logo = defineAsyncComponent(() => import('/@/layouts/logo/index.vue'));
const Horizontal = defineAsyncComponent(() => import('/@/layouts/navMenu/horizontal.vue'));
