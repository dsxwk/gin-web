...
export function formatTwoStageRoutes(arr) {
    ...
    const cacheList = [];
    arr.forEach((v) => {
        v.meta['isHide'] = v.meta['isHide'] == 1 ? true : false;
        v.meta['isKeepAlive'] = v.meta['isKeepAlive'] == 1 ? true : false;
        v.meta['isAffix'] = v.meta['isAffix'] == 1 ? true : false;
        v.meta['isIframe'] = v.meta['is_iframe'] == 1 ? true : false;
        if (v.path === '/') {
            newArr.push({
